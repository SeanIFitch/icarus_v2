...
_svg_resources = {
    ...
    'file_export': '<svg width="24" height="24" viewBox="0 0 24 24"><path d="M12 12ZM5.05 22.375l-1.4-1.425 2.95-2.95H4.3v-2h5.65v5.65h-2v-2.225L5.05 22.375ZM12 21.375v-2h6v-11H13V3.375H6v10h-2v-10q0-.825.588-1.413Q5.175 1.375 6 1.375h8l6 6v12q0 .825-.588 1.413-.587.587-1.412.587H12Z"/></svg>',
