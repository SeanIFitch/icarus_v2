...
class HistoryPlot(QWidget):
    ...
    LINE_STYLES = {
        HistStat.O_PRESS: ('#FFDC00', Qt.SolidLine),  # yellow
        HistStat.S_PRESS: ('#FFDC00', Qt.DashLine),  # yellow dashed
        HistStat.DO_SLOPE: ('#59D8E6', Qt.SolidLine),  # cyan
        HistStat.DS_SLOPE: ('#59D8E6', Qt.DashLine),  # cyan dashed
        HistStat.PO_SLOPE: ('#B9121B', Qt.SolidLine),  # red
        HistStat.PS_SLOPE: ('#B9121B', Qt.DashLine),  # red dashed
        HistStat.DO_SWITCH: ('#59D8E6', Qt.SolidLine),  # cyan
        HistStat.DS_SWITCH: ('#59D8E6', Qt.DashLine),  # cyan dashed
        HistStat.PO_SWITCH: ('#B9121B', Qt.SolidLine),  # red
        HistStat.PS_SWITCH: ('#B9121B', Qt.DashLine),  # red dashed
    }
